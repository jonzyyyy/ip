...
class DataStorageTest {
    ...
    @Test
    void testLoadData_WithTasks() throws IOException {
        ...
        assertEquals("deadline Submit assignment /by 2024/02/05 0000", taskList.getList().get(1).getUserInput(), "Second task should match");
    }
}